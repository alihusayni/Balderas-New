                ...
                <div className="flex flex-wrap items-center justify-between gap-4 pt-2">
                  <div className="flex min-w-0 items-center gap-2 text-[#4F5B79]">
                    <ArticleAuthorAvatarIcon
                      ...
                      aria-hidden
                    />
                    <span className="font-maison text-[16px] font-bold leading-[22px] tracking-[-0.02em] text-[#4F5B79] lg:text-2xl">
              ...
              <div className="w-full sm:w-[300px]">
                ...
                >
                  <Link
                    ...
                    className="font-maison flex items-center gap-3 text-lg font-bold tracking-[-0.02em] sm:gap-4 sm:text-2xl md:text-4xl lg:gap-5 lg:text-5xl xl:text-[24px]"
                  >
        ...
        <div className="mx-auto flex w-full max-w-container flex-col items-center gap-12 px-6 lg:gap-16 lg:px-10">
          ...
          <div className="flex w-full flex-col items-center gap-4 sm:flex-row sm:justify-center sm:gap-[10px]">
            ...
            >
              <Link
                href="/#contact"
                className="font-maison text-lg font-bold tracking-[-0.02em] sm:text-2xl md:text-4xl lg:text-5xl xl:text-[24px]"
              >
                Contact Us
              </Link>
            </Button>
