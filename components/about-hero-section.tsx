  ...
  return (
    <section className="-mt-[130px] relative w-full overflow-hidden">
      <HeroParallaxBackground
        ...
        alt="Demolition OC crew loading a dumpster on site in Orange County"
        priority
      ...
      <div className="relative z-10 mx-auto flex min-h-[760px] w-full max-w-container items-end px-6 pt-[200px] pb-[80px] lg:min-h-[1040px] lg:px-10 lg:pt-[230px] lg:pb-[100px]">
        <div className="max-w-[760px] text-[var(--color-brand-white)] sm:max-w-[680px] md:max-w-[1100px]">
          <HeroHeading>
            Behind the Hammer: The Story of Demolition OC
          </HeroHeading>
          <HeroSubheading>
            At Demolition OC, we believe every project starts with a
            clean, safe site. From home renovations to commercial clear-outs,
            we prepare your space for what&apos;s next.
            Our mission is simple: deliver a higher standard of demolition and
            junk removal across Orange County.
          </HeroSubheading>
        </div>
      </div>
